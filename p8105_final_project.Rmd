...
Here we obtain the linear regression model of mortality = 4.103 - 0.226*localityMetropolitan -1.145*localityNonmetropolitan. 
...
ggplot(gp_cod_data, aes(x = year, y = mean_ped, fill = locality)) + geom_point(stat = "identity") + geom_smooth() + facet_grid(. ~ locality) 
...
=======
  summarise(mean_ped = mean(percent_excess_death))
>>>>>>> 9d7a4834bc95e955dd3c7b0f4831a232f94573d5
