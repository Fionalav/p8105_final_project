...
cod_data %>%
  ...
  ggplot(aes(x = cause_of_death, y = percent_excess_death, color = cause_of_death)) +
  geom_boxplot() +
...
cod_lm_yz = lm(percent_excess_death ~cause_of_death, data = cod_data)
broom::tidy(cod_lm_yz)
#summary(cod_lm_yz)
#anova(cod_lm_yz)
```
