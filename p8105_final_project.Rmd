...
```
```{r Questions}
#Do we need to include the plot of the linear model?
#Why is everything significant? Is there a problem?
#How to make a scatterplot for regression with catagorical variables?
#How to interpret percent excess death?
```
